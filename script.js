...
robotGroup.add(body);
    ...
    function animate(now = 0) {
        ...
        robotGroup.position.x = (smoothMouseX * 0.85) + Math.sin(time * 0.45) * 0.18;
        robotGroup.position.y = robotBaseY + (smoothMouseY * 0.35) + Math.sin(time * 0.8) * 0.12;

        body.rotation.y   = Math.sin(time * 0.35) * 0.08;
